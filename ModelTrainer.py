...
def data_augmentations(resize_target, crop_target, normalization_vec,
                       rotation_angle=None, center_crop=False, flip=True):
...
class ModelTrainer:
    ...
    def train(self, path_img_dir, path_file_train, path_file_validation, batch_size,
        ...
        transformSequence_val = data_augmentations(trans_resize_size, trans_crop_size, normalization_vec,
                                                   rotation_angle=None, center_crop=True, flip=False)
